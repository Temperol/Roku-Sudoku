...
sub onCategorySelected(obj)
	...
	? "http://127.0.0.1:8080/content/" + m.category_select_screen.getField("selected_category_content") + ".xml"
	m.content_select_screen.contenturi = "http://127.0.0.1:8080/content/" + m.category_select_screen.getField("selected_category_content") + ".xml"
